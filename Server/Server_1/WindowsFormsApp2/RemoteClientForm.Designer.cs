...
namespace WindowsFormsApp2
{
    partial class RemoteClientForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "원격제어";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.RemoteClientForm_FormClosing);
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.RemoteClientForm_FormClosed);
